...
class localStorageUtil {
  ...
  static removeProductNumFromShoppingCartLocal(id, color = "", size = "",type=0) {
    ...
    if (this.getItem(LOCAL_CONSTANTS.shoppingCartTotal)) {
      shoppingCartTotal = parseFloat(this.getItem(LOCAL_CONSTANTS.shoppingCartTotal)
      );
    }
    if (this.getItem(LOCAL_CONSTANTS.shoppingCartTotalNum)) {
      shoppingCartTotalNum = parseFloat(this.getItem(LOCAL_CONSTANTS.shoppingCartTotalNum)
      );
    }
    console.log('= = = = =  = = = =');
